...
if __name__ == "__main__":
    ...
    if args.network == "normal":
        ...
        sdae = StackedDAE(input_dim=input_dim, z_dim=z_dim, binary=False,
                        encodeLayer=[256, 256, 512], decodeLayer=[512, 256, 256], activation="relu",
                        dropout=0)
    elif args.network == "deep":
        sdae = StackedDAE(input_dim=input_dim, z_dim=z_dim, binary=False,
                        encodeLayer=[500, 500, 500, 2000], decodeLayer=[2000, 500, 500, 500], activation="relu",
                        dropout=0)
    ...
    if args.network == "normal":
        ...
        sdae_model_save_path = f"./pretrained_sphere_models_compact/D{args.dim}"
    elif args.network == "deep":
        sdae_model_save_path = f"./pretrained_sphere_models_deep/D{args.dim}"
