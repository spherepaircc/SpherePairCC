...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='pretrain sdae for dec models')
    ...
    # sdae_model_save_path is determined by args.finetune and args.dim
    if args.finetune == "True":
        sdae_model_save_path = f"./pretrained_sdae_models/D{args.dim}/finetune"
    else:
        sdae_model_save_path = f"./pretrained_sdae_models/D{args.dim}"
